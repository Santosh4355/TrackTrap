pest_code <- c(
  ...
  "LB", "OM", "SM", "SVB", "PC", "VCW", "WBCW", "WFT",
  "GWSS", "VMB", "LBAM", "EGVM", "CFF", "BLB", "CSB", "SCA",
  "WSAW", "WCM", "PWB", "AM", "BA", "TBW", "CFB", "CBB",
...
pest_name <- c(
  ...
  "Squash Vine Borer", "Plum Curculio", "Variegated Cutworm",
  ...
  "Tobacco Budworm", "Citrus Flat Mite", "Coffee Bean Borer",
...
lower_thresh <- c(
  ...
  54, 40, 39, 50, 50, 45, 50, 50,
  54, 58, 45, 50, 50, 46, 41, 50,
  50, 50, 50, 44.1, 50, 55, 46.4, 55.4,
...
upper_thresh <- c(
  ...
  93, 86, 86, 86, 88, 80, 95, 95,
  100, 90.5, 88, 86, 95, NA, NA, 95,
  86, 86, 86, 86, NA, 86, 95, 89.6,
...
flight_interval_dd <- c(
  ...
  680, 1000, 675, 1700, 1000, 1260, 1320, 460,
  1160, 1032, 1116, 830, 1357, 674, 1400, 180,
  NA, 180, NA, NA, NA, 873, 934, 562.5,
